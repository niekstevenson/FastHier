...
script_path <- if (length(file_arg)) {
  ...
  normalizePath("benchmarks/run_normal_normal_meanvar_hierarchy_compare.R")
}
...
stan_results_file <- file.path("benchmarks", "samples", "normal_normal_meanvar_hierarchy_compare_results.rds")
results_file <- file.path("benchmarks", "results", "normal_normal_meanvar_hierarchy_current_results.rds")
plot_file <- file.path("benchmarks", "results", "normal_normal_meanvar_hierarchy_current_posteriors.png")
